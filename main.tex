...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Head-on collision.}{\includegraphics[width=0.475\linewidth]{Figures/T1/HocWall1_P3 (0.21).pdf}}
    \hspace*{\fill}
    \subcaptionbox{Wall.}{\includegraphics[width=0.475\linewidth]{Figures/T1/HocWall1_P3 (0.96).pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
...
\begin{minipage}{\linewidth}
    ...
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Overtaking collision of a wave of $\displaystyle{\epsilon = 0.44}$ by one of $\displaystyle{\epsilon = 0.96}$.}
\end{minipage}
\end{figure}
\end{frame}
% #3
...
\begin{minipage}{\linewidth}
    ...
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Water depth ($\displaystyle{h}$) and velocity ($\displaystyle{u}$) evolution.}
\end{minipage}
\end{figure}
\end{frame}
\begin{frame}[c]
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Gauge $\displaystyle{g_{0}}$.}{\includegraphics[width=0.475\linewidth]{}}
    \hspace*{\fill}
    \subcaptionbox{Gauge $\displaystyle{g_{1}}$.}{\includegraphics[width=0.475\linewidth]{}}
    \hspace*{\fill}
    \subcaptionbox{Gauge $\displaystyle{g_{2}}$.}{\includegraphics[width=0.475\linewidth]{}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Comparison between experiments ($\displaystyle{\circ}$) and computations (\rule[0.5ex]{1em}{0.5pt}): $\displaystyle{\alpha=1}$ for the wave of $\displaystyle{\epsilon = 0.07}$.}
\end{minipage}
\end{figure}
\end{frame}
\begin{frame}[c]
...
\begin{minipage}{\linewidth}
    ...
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Comparison between experiments ($\displaystyle{\circ}$) and computations (\rule[0.5ex]{1em}{0.5pt}): $\displaystyle{\alpha=1}$ for the wave of $\displaystyle{\epsilon = 0.12}$.}
\end{minipage}
\end{figure}
\end{frame}
