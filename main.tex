...
%--------------------------------------------------------------
% Title page
\title[R\'{e}union R3C]{R\'{e}union d'unit\'{e} (R3C)}
\author{Filipe Forte Tenreiro \texorpdfstring{\\}{} [0.50em] \footnotesize{\textit{Sous la supervision} de M. Kazolea\texorpdfstring{\textsuperscript{a}}{} et A. G. Filippini\texorpdfstring{\textsuperscript{b}}{}} \texorpdfstring{\\}{} [0.25em] \texorpdfstring{\textsuperscript{a}}{}\tiny{INRIA Center of the University of Bordeaux - CARDAMOM team - 200 av. de la Vieille Tour, 33405 Talence, France} \texorpdfstring{\\}{} [0.25em] \texorpdfstring{\textsuperscript{b}}{}\tiny{BRGM, French Geological Survey - Coastal Risks and Climate Change team (R3C) - 3 av. Guillemin, 45100 Orl{\'{e}}ans, France}}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.75\linewidth]{Figures/Motivation/Motivation (1).pdf}
\caption{Typical zones used to describe coastal wave propagation.}
\end{figure}
\begin{itemize}
    \item\textit{Far} from the shore: $\displaystyle{\epsilon\ll 1}$ (\textit{small} amplitude assumption).
    \pause
    \item\textit{Near}-shore phenomena: shoaling, breaking, run-up/down.
    \begin{itemize}
        \item Euler equations.
        \item Nonlinear shallow water equations (\textit{long} wave assumption: $\displaystyle{\mu\ll 1}$).
        \item Use the \textit{Green-Nagdhi} model to account for \textcolor{red}{dispersive effects} ($\displaystyle{\altmathcal{O}(\mu)}$).
    \end{itemize}
\end{itemize}
\end{frame}
%
...
\begin{myenum}
    \item\textit{AeroSol}:
    \begin{itemize}
        \item Optimised the \textit{assembly} and \textit{solving} of linear systems of the form $\displaystyle{Ax=b}$ using \textit{PETSc}.
    \end{itemize}
    \item\textit{Uhaina}:
    \begin{itemize}
        \item Coded the main routines for \textit{computing integrals} and \textit{assembling} the linear system (in parallel).
        \item \underline{Yet to do}:
        \begin{itemize}
            \item Construct \textit{weak} derivative and Laplace operators.
            \item Clean up the code.
        \end{itemize}
    \end{itemize}
    \item\textit{Uhaina} toy code:
    \begin{itemize}
        \item \underline{Yet to do}:
        \begin{itemize}
        \item Further test the wet/dry algorithm.
        \item Wave generation.
        \item Run 2D test cases.
        \end{itemize}
    \end{itemize}
\end{myenum}
\end{frame}
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Linear ($\displaystyle{\mathbb{P}^{1}}$).}
    {\includegraphics[width=0.285\linewidth]{Figures/DG/Polynomial reconstruction (FV)/PR (1.1).pdf}}
    \hspace*{\fill}
    \subcaptionbox{Quadratic ($\displaystyle{\mathbb{P}^{2}}$).}
    {\includegraphics[width=0.285\linewidth]{Figures/DG/Polynomial reconstruction (FV)/PR (1.2).pdf}}
    \hspace*{\fill}
    \subcaptionbox{Cubic ($\displaystyle{\mathbb{P}^{3}}$).}
    {\includegraphics[width=0.285\linewidth]{Figures/DG/Polynomial reconstruction (FV)/PR (1.3).pdf}}
    \hspace*{\fill}
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{\mathbb{P}^{1}}$: $\displaystyle{3}$ \textit{monomials}.}
    {\includegraphics[width=0.285\linewidth]{Figures/DG/Discretisation stencil (FV)/DS (1.1).pdf}}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{\mathbb{P}^{2}}$: $\displaystyle{6}$ \textit{monomials}.}
    {\includegraphics[width=0.285\linewidth]{Figures/DG/Discretisation stencil (FV)/DS (1.2).pdf}}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{\mathbb{P}^{n}}$: $\displaystyle{\binom{n+2}{n}}$ \textit{monomials}.}
    {\includegraphics[width=0.285\linewidth]{Figures/DG/Discretisation stencil (FV)/DS (1.3).pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Polynomial reconstructions about the \textit{face}.}
\end{minipage}
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{\gls{fv}.}
    {\includegraphics[width=0.450\linewidth]{Figures/DG/Discretisation stencil (FV)/DS (2.1).pdf}}
    \hspace*{\fill}
    \subcaptionbox{\gls{dg}.}
    {\includegraphics[width=0.450\linewidth]{Figures/DG/Discretisation stencil (FV)/DS (2.2).pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
...
\begin{frame}[c]
\begin{figure}[!htb]
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Cell/CELL_PAMPA_VERT_LOCAL.pdf}}
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{1}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Face/FACE_PAMPA_VERT_LOCAL_AND_NOT_FRONTIER_0.pdf}}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{2}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Face/FACE_PAMPA_VERT_LOCAL_AND_NOT_FRONTIER_1.pdf}}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{3}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Face/FACE_PAMPA_VERT_LOCAL_AND_NOT_FRONTIER_2.pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{1}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Cell/CELL_PAMPA_VERT_OVERLAP_0.pdf}}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{2}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Cell/CELL_PAMPA_VERT_OVERLAP_1.pdf}}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{3}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Cell/CELL_PAMPA_VERT_OVERLAP_2.pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{1}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Face/FACE_PAMPA_VERT_FRONTIER_0.pdf}}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{2}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Face/FACE_PAMPA_VERT_FRONTIER_1.pdf}}
    \hspace*{\fill}
    \subcaptionbox{Partition $\displaystyle{3}$.}
    {\includegraphics[width=0.215\linewidth]{Figures/DG/Face/FACE_PAMPA_VERT_FRONTIER_2.pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
...
% #1
\subsection*{Test 1: Head-on collision and symmetry boundary conditions}
\begin{frame}[c]
\begin{figure}[!htb]
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Wall.}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T1/Wall/21/}{1}{150}}
    \hspace*{\fill}
    \subcaptionbox{Head-on collision.}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T1/Hoc/21/}{1}{150}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Free-surface elevation ($\displaystyle{\zeta^{\prime}}$) distribution for the wave of $\displaystyle{\epsilon = 0.21}$.}
\end{minipage}
\end{figure}
\end{frame}
\begin{frame}[c]
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Wall.}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T1/Wall/96/}{1}{150}}
    \hspace*{\fill}
    \subcaptionbox{Head-on collision.}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T1/Hoc/96/}{1}{150}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Free-surface elevation ($\displaystyle{\zeta^{\prime}}$) distribution for the wave of $\displaystyle{\epsilon = 0.96}$.}
\end{minipage}
\end{figure}
\end{frame}
\begin{frame}[c]
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{\epsilon = 0.21}$.}{\includegraphics[width=0.475\linewidth]{Figures/T1/HocWall1_P3 (0.21).pdf}}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{\epsilon = 0.96}$.}{\includegraphics[width=0.475\linewidth]{Figures/T1/HocWall1_P3 (0.96).pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
...
\end{frame}
% #2
\subsection*{Test 2: Overtaking collision}
\begin{frame}[c]
\begin{figure}[!htb]
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Time frames.}{\includegraphics[width=0.475\linewidth]{Figures/T2/Oc_P3.pdf}}
    \hspace*{\fill}
    \subcaptionbox{Time evolution.}{\animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T2/frames/}{1}{150}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Overtaking collision of a wave of $\displaystyle{\epsilon = 0.44}$ by another of $\displaystyle{\epsilon = 0.96}$.}
\end{minipage}
\end{figure}
\end{frame}
% #3
\subsection*{Test 3: Dispersive dam-break}
\begin{frame}[c]
\begin{figure}[!htb]
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Water depth ($\displaystyle{h}$).}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T3/frames/h/}{1}{150}}
    \hspace*{\fill}
    \subcaptionbox{Velocity ($\displaystyle{u}$).}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T3/frames/u/}{1}{150}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Water depth ($\displaystyle{h}$) and velocity ($\displaystyle{u}$) time evolution.}
\end{minipage}
\end{figure}
\end{frame}
\begin{frame}[c]
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Water depth ($\displaystyle{h}$).}{\includegraphics[width=0.475\linewidth]{Figures/T3/Ddb_h.pdf}}
    \hspace*{\fill}
    \subcaptionbox{Velocity ($\displaystyle{u}$).}{\includegraphics[width=0.475\linewidth]{Figures/T3/Ddb_u.pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Water depth ($\displaystyle{h}$) and velocity ($\displaystyle{u}$) distribution at $\displaystyle{t = 47.434s}$ for $\displaystyle{\mathbb{P}^{1}}$, $\displaystyle{\mathbb{P}^{2}}$ and $\displaystyle{\mathbb{P}^{3}}$.}
\end{minipage}
\end{figure}
\end{frame}
% #4
\subsection*{Test 4: Grilli \textit{et al.}}
\begin{frame}[c]
\begin{figure}[!htb]
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{y-\text{axis}:z^{\prime}}$.}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T4/frames/fig1/}{1}{150}}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{y-\text{axis}:\zeta^{\prime}}$.}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T4/frames/fig2/}{1}{150}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Shoaling of a wave of $\displaystyle{\epsilon = 0.20}$ on a $\displaystyle{1:35}$ slope.}
\end{minipage}
\end{figure}
\end{frame}
\begin{frame}[c]
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Incident waves at gauge $\displaystyle{g_{0}}$.}{\includegraphics[width=0.475\linewidth]{Figures/T4/Grilli0 (gn).pdf}}
    \hspace*{\fill}
    \subcaptionbox{Shoaling waves at gauges $\displaystyle{g_{1}-g_{9}}$.}{\includegraphics[width=0.475\linewidth]{Figures/T4/Grillik (gn).pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Comparison between experiments ($\displaystyle{\circ}$) and computations (\rule[0.5ex]{1em}{0.5pt}): $\displaystyle{\alpha=1}$.}
\end{minipage}
\end{figure}
\end{frame}
\begin{frame}[c]
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{Incident waves at gauge $\displaystyle{g_{0}}$.}{\includegraphics[width=0.475\linewidth]{Figures/T4/Grilli0 (e-gn).pdf}}
    \hspace*{\fill}
    \subcaptionbox{Shoaling waves at gauges $\displaystyle{g_{1}-g_{9}}$.}{\includegraphics[width=0.475\linewidth]{Figures/T4/Grillik (e-gn).pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Comparison between experiments ($\displaystyle{\circ}$) and computations (\rule[0.5ex]{1em}{0.5pt}): $\displaystyle{\alpha=1.159}$.}
\end{minipage}
\end{figure}
\end{frame}
% #5
\subsection*{Test 5: Reflection of shoaling waves (M. Walkley)}
\begin{frame}[c]
\begin{figure}[!htb]
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{t = 0s}$.}{\includegraphics[width=0.475\linewidth]{Figures/T5/Ref2 (t0).pdf}}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{t = 30s}$.}{\includegraphics[width=0.475\linewidth]{Figures/T5/Ref2 (tf).pdf}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
...
\begin{minipage}{\linewidth}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{y-\text{axis}:z^{\prime}}$.}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T5/frames/fig1/}{1}{150}}
    \hspace*{\fill}
    \subcaptionbox{$\displaystyle{y-\text{axis}:\zeta^{\prime}}$.}{
    \animategraphics[width=0.475\linewidth,autoplay,loop]{30}{Figures/T5/frames/fig2/}{1}{150}}
    \hspace*{\fill}
    \vspace{-0.5\baselineskip}
    \caption{Shoaling and reflection of waves of $\displaystyle{\epsilon = 0.07}$ and $\displaystyle{0.12}$ on a $\displaystyle{1:50}$ slope.}
\end{minipage}
\end{figure}
\end{frame}
% Appendix
